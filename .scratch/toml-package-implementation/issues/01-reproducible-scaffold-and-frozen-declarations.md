...
- [ ] The dependency direction remains `toml` to `temporal`; semantic workflows compile when RTTI is disabled while typed workflows report their documented capability boundary.
